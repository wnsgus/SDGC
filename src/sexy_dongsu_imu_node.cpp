...
std_srvs::Empty all_data_reset_cmd;
ros::ServiceServer euler_angle_init_service;
std_srvs::Empty euler_angle_init_cmd;
ros::ServiceServer euler_angle_reset_service;
std_srvs::Empty euler_angle_reset_cmd;
ros::ServiceServer pose_velocity_reset_service;
std_srvs::Empty pose_velocity_reset_cmd;
ros::ServiceServer reboot_sensor_service;
std_srvs::Empty reboot_sensor_cmd;
